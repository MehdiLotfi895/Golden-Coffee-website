...
export default function MenuMobile({setDark,aboutRef,blogsRef,contactRef,mainRef,scrollToRef}) {
  ...
  return (
    <>
    <div className="fixed w-screen h-screen bg-[rgba(0,0,0,0.6)] backdrop-blur-xs z-20" onClick={()=>{Navigate("/")}}>
    </div>
    <div className={`w-60 h-screen top-0 right-0 z-20 px-2 text-sm overflow-y-scroll  fixed ${cssSring}`}>
        ...
        <ul className="mt-5 ">
         ...
         <li className="menuLinks"><div className="Links" ><img src="/home.png" alt="" className="imgLinks"/><p className="text-orange-300" onClick={()=>{scrollToRef(mainRef);Navigate("/")}}>صفحه اصلی</p></div></li>
